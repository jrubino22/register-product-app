...
const Index = ({warranties}) => {
    ...
    const warrantyButton = async (_id) => {
        ...
        const response = await fetch(`v-syndicate-warranty-app.herokuapp.com/warranty/${_id}`, requestOptions);
        await response.json();   
        location.reload()
        return false
    }
...
export async function getServerSideProps(){
    const response = await fetch('v-syndicate-warranty-app.herokuapp.com/warranties')
